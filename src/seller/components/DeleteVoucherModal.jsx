...
const DeleteVoucherModal = ({ deleteVoucherId, setDeleteVoucherId, setVouchers }) => {
  const handleDelete = () => {
        ...
        >
          ...
          >
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={() => setDeleteVoucherId(null)} className="text-gray-500 hover:text-gray-700">
                <FaTimes />
              </button>
            </div>
